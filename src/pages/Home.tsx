          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="bg-card rounded-3xl shadow-card border border-border p-6 md:p-8">
                {/* Average Score */}
                <div className="bg-gradient-navy rounded-2xl p-6 mb-6 text-primary-foreground">
                  <p className="text-primary-foreground/60 text-sm mb-1">Average Credit Score</p>
                  <div className="flex items-baseline gap-2">
                    <span className="text-5xl font-display font-bold">756</span>
                    <span className="text-primary-foreground/60">/ 900</span>
                  </div>
