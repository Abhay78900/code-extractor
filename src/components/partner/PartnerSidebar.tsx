...
const PartnerSidebar: React.FC<PartnerSidebarProps> = ({ currentPage, onLogout, partner }) => {
  ...
  return (
    <aside className="w-64 bg-gradient-to-b from-purple-900 to-purple-800 text-primary-foreground min-h-screen flex flex-col shrink-0">
      {/* Logo */}
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all ${
                isActive
                  ...
                  : 'text-purple-200 hover:bg-purple-700/50 hover:text-primary-foreground'
              }`}
            >
      ...
      <div className="p-4 border-t border-purple-700/50">
        <Button
          variant="ghost"
          onClick={onLogout}
          className="w-full justify-start gap-3 text-purple-200 hover:text-primary-foreground hover:bg-purple-700/50"
        >
